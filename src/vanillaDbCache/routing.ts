...
export const isVanillaDbPackPath = (
  ...
  dbPackName: string,
): boolean => dataFolder != undefined && isSamePackPath(candidatePath, nodePath.join(dataFolder, dbPackName));
 ...
 */
export const getIndexedDbTablePathsForPrefix = (packedFiles: readonly PackedFile[], prefix: string): string[] =>
  packedFiles
